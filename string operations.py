...
# Rollno:35
#Practical no 2: Write python program to perform string operations
# a)To display word with the longest length 
# b)To determine the frequency of occurence of particular character in the string
# c)To check whther given string is palindrome or not
# d)To display index of first appearence of the substring
