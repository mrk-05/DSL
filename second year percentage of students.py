...
#Practical no 5: Write a python program to store second year percentage of students in array. 
...
def accept_perc():
    ...
    for i in range(0, no_stud):
        a.append(float(input("Enter the Second Year % of Student[{0}] : ".format(i))))
    return a
...
#Enter the Second Year % of Student[0] : 55
#Enter the Second Year % of Student[1] : 66
#Enter the Second Year % of Student[2] : 77
